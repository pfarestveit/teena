class Activity
  ...
  ACTIVITIES = [
      ...
      GET_VIEW_ASSET = new('get_view_asset', 'Receive a view in the Asset Library', 0, nil, 'Views', 0),
      ...
      GET_LIKE = new('get_like', 'Receive a like in the Asset Library', 1, nil, 'Likes', 0),
      ...
      GET_COMMENT = new('get_comment', 'Receive a comment in the Asset Library', 1, nil, 'Comments', 0),
      GET_COMMENT_REPLY = new('get_comment_reply', 'Receive a reply on a comment in the Asset Library', 1, nil, 'Comments', 0),
      ...
      GET_PIN_ASSET = new('get_pin_asset', 'Receive a pin of an asset in the Asset Library', 1, nil, 'Pins', 0),
      ...
      GET_ADD_ASSET_TO_WHITEBOARD = new('get_whiteboard_add_asset', 'Have one\'s asset added to a whiteboard', 0, nil, 'Asset Usage', 0),

      REMIX_WHITEBOARD = new('remix_whiteboard', 'Remix a whiteboard', 0, 'remixed this asset in a whiteboard', 'Remixes', 10),
      GET_REMIX_WHITEBOARD = new('get_remix_whiteboard', 'Have one\'s whiteboard remixed', 0, nil, 'Remixes', 0),
