class Activity
  ...
  ACTIVITIES = [
    ...
    ADD_DISCUSSION_TOPIC = new('discussion_topic', 'Add a new topic in Discussions', 5, nil, nil, 0),
    ADD_DISCUSSION_ENTRY = new('discussion_entry', 'Add an entry on a topic in Discussions', 3, nil, nil, 0),
