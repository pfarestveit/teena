class RipleyTool
  ...
  def initialize(name, path, navigation, account, dev_key=nil, tool_id=nil)
    @name = name
    @account = account
    @dev_key = dev_key
  ...
  TOOLS = [
    ...
    MANAGE_SITES = new('Create & Manage Sites', 'manage_sites', 'user_navigation', Utils.canvas_uc_berkeley_sub_account),
