class Squad < Team
  ...
  SQUADS = [
      ...
      MFB_AA = new({code: 'MFB', name: 'Football', parent_team: Team::FBM}),
      ...
      MSW_AA = new({code: 'MSW', name: 'Men\'s SwimDive', parent_team: Team::SDM}),
      ...
      MTR_AA = new({code: 'MTR', name: 'Men\'s TrackCC', parent_team: Team::TOM}),
