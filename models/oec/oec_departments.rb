class OECDepartments
  ...
  DEPARTMENTS = [
      ...
      BANGLA = new('BANGLA', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      ...
      FILIPN = new('FILIPN', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      ...
      HIN_URD = new('HIN-URD', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      ...
      KHMER = new('KHMER', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      ...
      MALAY_I = new('MALAY/I', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      ...
      PUNJABI = new('PUNJABI', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      ...
      SANSKR = new('SANSKR', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      S_ASIAN = new('S ASIAN', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      SCANDIN = new('SCANDIN', 'Scandinavian', 'SCANDIN', %w(F G), true),
      SEASIAN = new('SEASIAN', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      S_SEASN = new('S,SEASN', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      ...
      SSEASN = new('SSEASN', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      STAT = new('STAT', 'Statistics', 'STAT', %w(F G), true),
      SWEDISH = new('SWEDISH', 'Swedish', 'SWEDISH', %w(F G), true),
      TAGALG = new('TAGALG', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      TAMIL = new('TAMIL', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      TELUGU = new('TELUGU', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      THAI = new('THAI', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
      ...
      VIETNMS = new('VIETNMS', 'South and Southeast Asian Studies', 'SSEASN', %w(F G), true),
