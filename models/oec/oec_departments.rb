class OECDepartments
  ...
  DEPARTMENTS = [
      ...
      BURMESE = new('BURMESE', 'Burmese', 'BURMESE', %w(F G), true),
      ...
      GMS = new('GMS', 'Global and Metropolitan Studies', 'GMS', %w(F G), true),
      ...
      HINDI = new('HINDI', 'Hindi', 'HINDI', %w(F G), true),
      ...
      URDU = new('URDU', 'Urdu', 'URDU', %w(F G), true),
