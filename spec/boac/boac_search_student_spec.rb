  ...
  describe 'BOAC' do
    ...
    begin
      ...
      test_config.test_students.each do |student|
        ...
        begin
          @homepage.type_non_note_simple_search_and_enter student.first_name
          ...
          unless student.first_name[0..2] == student.first_name
            @homepage.type_non_note_simple_search_and_enter student.first_name[0..2]
          ...
          @homepage.type_non_note_simple_search_and_enter student.last_name
          ...
          unless student.last_name[0..2] == student.last_name
            @homepage.type_non_note_simple_search_and_enter student.last_name[0..2]
          ...
          @homepage.type_non_note_simple_search_and_enter "#{student.first_name} #{student.last_name}"
          ...
          @homepage.type_non_note_simple_search_and_enter "#{student.last_name}, #{student.first_name}"
          ...
          @homepage.type_non_note_simple_search_and_enter "#{student.first_name[0..2]} #{student.last_name[0..2]}"
          ...
          @homepage.type_non_note_simple_search_and_enter "#{student.last_name[0..2]}, #{student.first_name[0..2]}"
          ...
          @homepage.type_non_note_simple_search_and_enter student.sis_id.to_s
          ...
          @homepage.type_non_note_simple_search_and_enter student.sis_id.to_s[0..4]
          ...
          @homepage.type_non_note_simple_search_and_enter student.email
          ...
          @homepage.type_non_note_simple_search_and_enter student.email[0..4]
