                      ...
                      sections.each do |section|
                        begin
                          ...
                          if class_page_link_present && !pages_tested.include?("#{term_id} #{section_data[:ccn]}")
                            ...
                            if api_section_page.student_sids.length > BOACUtils.config['class_page_max_size']
                              logger.warn "Skipping #{class_test_case} because there are way too many students and this test script will run forever"
                            else
