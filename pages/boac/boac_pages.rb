...
module BOACPages
  ...
  link(:flight_data_recorder_link, xpath: '//a[contains(text(), "Flight Data Recorder")]')
  link(:flight_deck_link, xpath: '//a[contains(text(), "Flight Deck")]')
  link(:pax_manifest_link, xpath: '//a[contains(text(), "Passenger Manifest")]')
  link(:degree_checks_link, xpath: '//a[contains(text(), "Degree Checks")]')
  link(:settings_link, xpath: '//a[contains(text(), "Profile")]')
  link(:log_out_link, xpath: '//a[contains(text(), "Log Out")]')
  link(:feedback_link, xpath: '//a[contains(text(), "Feedback/Help")]')
