  ...
  def collect_users_searchable_data(driver, all_students)
    ...
    users_data = all_students.map do |user|
      ...
      get_data(driver, user)
      {
        ...
        :term_units => (user_sis_data[:term_units] if user_sis_data[:term_units]),
        ...
        :expected_grad_term_id => (user_sis_data[:expected_grad_term_id] if user_sis_data[:expected_grad_term_id]),
