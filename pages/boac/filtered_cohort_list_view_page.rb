    ...
    module CohortPages
      ...
      class FilteredCohortListViewPage < FilteredCohortPage
        ...
        def expected_sids_by_team(user_data, search_criteria)
          expected_users = expected_search_results(user_data, search_criteria)
          sorted_users = expected_users.sort_by { |u| [u[:squad_names].sort.first, u[:last_name].downcase, u[:first_name].downcase, u[:sid]] }
          sorted_users.map { |u| u[:sid] }
        end
        ...
        def expected_sids_by_gpa(user_data, search_criteria)
          expected_users = expected_search_results(user_data, search_criteria)
          sorted_users = expected_users.sort_by { |u| [u[:gpa].to_f, u[:last_name].downcase, u[:first_name].downcase, u[:sid]] }
          sorted_users.map { |u| u[:sid] }
        end
        ...
        def expected_sids_by_level(user_data, search_criteria)
          ...
          users_by_first_name = expected_users.sort_by { |u| [u[:last_name].downcase, u[:first_name].downcase, u[:sid]] }
        ...
        def expected_sids_by_major(user_data, search_criteria)
          expected_users = expected_search_results(user_data, search_criteria)
          sorted_users = expected_users.sort_by { |u| [u[:majors].sort.first, u[:last_name].downcase, u[:first_name].downcase, u[:sid]] }
          sorted_users.map { |u| u[:sid] }
        end
        ...
        def expected_sids_by_units(user_data, search_criteria)
          expected_users = expected_search_results(user_data, search_criteria)
          sorted_users = expected_users.sort_by { |u| [u[:units].to_f, u[:last_name].downcase, u[:first_name].downcase, u[:sid]] }
          sorted_users.map { |u| u[:sid] }
        end
